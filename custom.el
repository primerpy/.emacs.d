(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (rainbow-mode impatient-mode ob-ipython org org-plus-contrib neotree leuven-theme jedi epc ess ess-R-data-view ess-R-object-popup ess-smart-equals ess-smart-underscore ess-view org-bullets pandoc rust-mode crux undo-tree latex-preview-pane latex-extra xquery-mode virtualenvwrapper quickrun slime shell-pop scratch zoom-frm emmet-mode yasnippet visual-regexp-steroids visual-regexp typescript-mode smooth-scrolling smex smartscan smartparens restclient geiser racket-mode python-mode olivetti multiple-cursors markdown-mode macrostep gist flycheck expand-region ein edit-server magit helm-swoop helm-ag helm-projectile helm dash-at-point clojure-mode c-eldoc android-mode ace-window ace-jump-mode ag ido-vertical-mode transpose-frame ox-pandoc exec-path-from-shell page-break-lines solarized-theme cyberpunk-theme use-package)))
