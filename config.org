...
** Org Mode Table
The current org mode table is not compatible with markdown table
#+begin_src emacs-lisp
...
** Use Node and Babel to evaluate JS in Org Mode
#+begin_src emacs-lisp
(setenv "NODE_PATH"
  (concat
   (getenv "HOME") "/Dropbox/React/node_modules"  ":"
   (getenv "NODE_PATH")
  )
)
#+end_src
...
#+end_src
** Quickly Visiting isaaczhou Dir
#+begin_src emacs-lisp
(defun iz/visit-iz-config ()
  (interactive)
  (find-file "~/Dropbox/BlogHugo/isaaczhou"))

(global-set-key (kbd "C-c i") 'iz/visit-iz-config)
#+end_src
